...
<div class="form-group">
    <label for="kirimstok" class="control-label">Kirim Stok Ke Toko : </label>
    <input type="text" nama="kirimstok" id="kirimstok" value="" class="form-control inputanangka" required/>
</div>
...
<div class="row">
    ...
    <div class="col-sm-6 form-horizontal">
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" nama="profitubahtoko" id="profitubahtoko" value="" class="form-control inputanangka" placeholder="Keuntungan..." readonly/>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-sm-6 form-horizontal">
        <div class="form-group">
            <label for="stokubahtoko" class="control-label col-sm-4">Stok : </label>
            <div class="col-sm-8">
    ...
    <div class="col-sm-6 form-horizontal">
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="date" nama="tanggalubahtoko" id="tanggalubahtoko" value="" class="form-control inputanangka" />
            </div>
        </div>
    </div>
</div>
